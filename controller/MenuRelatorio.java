...
public class MenuRelatorio {
    ...
    private static void listarFuncionarios(ConexaoBanco conexaoBanco) {
        try (Connection conexao = conexaoBanco.getConexao();
             PreparedStatement statement = conexao.prepareStatement("SELECT funcionario_id, nome, sexo, idade, telefone, cpf, cargo, setor, salario FROM Funcionario");
             ResultSet resultSet = statement.executeQuery()) {

            System.out.println("ID | Nome | Sexo | Idade | Telefone | CPF | Cargo | Setor | Salário");
            while (resultSet.next()) {
                ...
                System.out.println(funcionarioId + " | " + nome + " | " + sexo + " | " + idade + " | " + telefone + " | " + cpf + " | " + cargo + " | " + setor + " | " + salario);
            }
